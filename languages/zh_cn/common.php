 ...
 * ============================================================================
 * $Author: fenghl $
 * $Date: 2008-01-31 09:34:28 +0800 (星期四, 31 一月 2008) $
 * $Id: common.php 14095 2008-01-31 01:34:28Z fenghl $
*/
...
$_LANG['sys_msg'] = '系统提示';
$_LANG['catalog'] = '目录';
$_LANG['please_view_order_detail'] = '课程已发货，详情请到用户中心订单详情查看';
$_LANG['user_center'] = '用户中心';
$_LANG['shop_closed'] = '网站盘点中，请您稍后再来...';
$_LANG['shop_upgrade'] = '网站升级中，管理员从 <a href="admin/">管理中心</a> 登录后，系统会自动完成升级';
...
$_LANG['ur_here'] = '当前位置:';
$_LANG['all_goods'] = '全部课程';
$_LANG['promotion_goods'] = '限时抢报';
$_LANG['best_goods'] = '精品课程';
$_LANG['new_goods'] = '新推课程';
$_LANG['hot_goods'] = '报名冠军';
$_LANG['view_cart'] = '查看课程书包';
$_LANG['catalog'] = '所有分类';
...
$_LANG['fittings_price'] = '相关资源价格：';
$_LANG['collect'] = '加入收藏夹';
$_LANG['add_to_cart'] = '加入课程书包';
$_LANG['return_to_cart'] = '放回课程书包';
$_LANG['search_goods'] = '课程搜索';
...
$_LANG['goods_attr'] = '课程属性';
$_LANG['goods_price_ladder'] = '价格阶梯';
$_LANG['ladder_price'] = '团报价';
$_LANG['shop_prices'] = '优惠价';
$_LANG['market_prices'] = '原价';
$_LANG['deposit'] = '团报保证金';
$_LANG['amount'] = '课程总价';
$_LANG['number'] = '报名数量';
$_LANG['handle'] = '操作';
...
$_LANG['activities'] = '课程正在进行的活动';

$_LANG['searchkeywords_notice'] = '匹配多个关键字全部，可用 "+" 或 "AND" 连接。如 win32 AND unix<br />匹配多个关键字其中部分，可用空格或 "OR" 连接。如 win32 OR unix';
$_LANG['hidden_outstock'] = '隐藏已脱销的课程';
$_LANG['keywords'] = '关键字';
$_LANG['sc_ds'] = '搜索简介';
$_LANG['button_search'] = '立即搜索';
$_LANG['no_search_result'] = '无法搜索到您要找的课程！';
$_LANG['all_category'] = '所有分类';
$_LANG['all_brand'] = '所有学校';
...
/* 课程比较JS语言项 */
$_LANG['compare_js']['button_compare'] = '比较选定课程';
$_LANG['compare_js']['exist'] = '您已经选择了%s';
$_LANG['compare_js']['count_limit'] = '最多只能选择4个课程进行对比';
$_LANG['compare_js']['goods_type_different'] = '\"%s\"和已选择课程类型不同无法进行对比';
...
$_LANG['collect_existed'] = '该课程已经存在于您的收藏夹中。';
$_LANG['collect_success'] = '该课程已经成功地加入了您的收藏夹。';
$_LANG['copyright'] = "&copy; 2005-%s %s 版权所有，并保留所有权利。";
$_LANG['no_ads_id'] = '没有指定广告的ID以及跳转的URL地址!';
$_LANG['remove_collection_confirm'] = '您确定要从收藏夹中删除选定的课程吗？';
$_LANG['err_change_attr'] = '没有找到指定的课程或者没有找到指定的课程属性。';

$_LANG['collect_goods'] = '收藏课程';
$_LANG['plus'] = '加';
$_LANG['minus'] = '减';
$_LANG['yes'] = '是';
$_LANG['no'] = '否';

$_LANG['same_attrbiute_goods'] = '相同%s的课程';
...
$_LANG['goods_exists'] = '对不起，您的课程书包中已经存在相同的课程。';
$_LANG['fitting_goods_exists'] = '对不起，您的课程书包中已经添加了该配件。';
$_LANG['invalid_number'] = '对不起，您输入了一个非法的课程数量。';
$_LANG['not_on_sale'] = '对不起，该课程已经下架。';
$_LANG['no_basic_goods'] = '对不起，您希望将该课程做为配件购买，可是课程书包中还没有该课程的基本件。';
$_LANG['cannt_alone_sale'] = '对不起，该课程不能单独销售。';
$_LANG['shortage'] = "对不起，该课程已经暂停销售。\n你现在要进行预约登记来预订该课程吗？";
$_LANG['shortage_little'] = "该课程已经满员。已将您的购货数量修改为 %d。\n您现在要去课程书包吗？";
$_LANG['oos_tips'] = '该课程已经满员。您现在要进行预约登记吗？';

$_LANG['addto_cart_success_1'] = "该课程已添加到课程书包，您现在还需要继续挑选课程吗？\n如果您希望马上报名，请点击“确定”按钮。\n如果您希望继续挑选课程，请点击“取消”按钮。";
$_LANG['addto_cart_success_2'] = "该课程已添加到课程书包，您现在还需要继续挑选课程吗？\n如果您希望继续挑选课程，请点击“确定”按钮。\n如果您希望马上报名，请点击“取消”按钮。";

/* 分页排序 */
$_LANG['sort']['goods_id'] = '按上架时间排序';
$_LANG['sort']['shop_price'] = '按价格排序';
$_LANG['sort']['last_update'] = '更新时间';
$_LANG['order']['DESC'] = '倒序';
$_LANG['order']['ASC'] = '正序';
$_LANG['pager_1'] = '总计 ';
$_LANG['pager_2'] = ' 个记录';
...
$_LANG['comment_custom'] = '评论失败。只有在网站报名过课程的注册会员才能发表评论。';
$_LANG['comment_brought'] = '评论失败。只有报名过此课程的注册用户才能评论该课程。';
$_LANG['anonymous'] = '匿名用户';

/* 其他信息 */
$_LANG['js_languages']['goodsname_not_null'] = '课程名不能为空！';

/* 课程比较 */
$_LANG['compare_remove'] = '移除';
$_LANG['compare_no_goods'] = '您没有选定任何需要比较的课程或者比较的课程数少于 2 个。';
...
$_LANG['order_placed'] = '您已经报名了，如果您想重新报名，请先取消原来的课程';
...
/* 缺货处理 */
$_LANG['oos'][OOS_WAIT] = '等待所有课程备齐后再发';
...
$_LANG['shop_notice'] = '网站公告';
$_LANG['order_already_received'] = '此报名已经确认过了，感谢您在本站报名，欢迎再次光临。';
$_LANG['order_invalid'] = '您提交的报名信息不正确。';
$_LANG['act_ok'] = '谢谢您通知我们您已确认参加学习，感谢您在本站报名，欢迎再次光临。';
$_LANG['receive'] = '收货确认';
$_LANG['buyer'] = '买家';
...
/* 选购中心 */
$_LANG['pick_out'] = '选购中心';
$_LANG['fit_count'] = "共有 %s 件课程符合条件";
$_LANG['goods_type'] = "课程类型";
$_LANG['remove_all'] = '移除所有';
$_LANG['advanced_search'] = '高级搜索';
$_LANG['activity'] = '本课程正在进行';
$_LANG['order_not_exists'] = '非常抱歉，没有找到指定的课程单。请和网站管理员联系。';
...
/* 团购部分语言项 */
$_LANG['group_buy'] = '团报活动';
$_LANG['group_buy_goods'] = '团报课程';
$_LANG['gb_goods_name'] = '团报课程：';
$_LANG['gb_start_date'] = '开始时间：';
$_LANG['gb_end_date'] = '结束时间：';
$_LANG['gbs_pre_start'] = '该团报活动尚未开始，请继续关注。';
$_LANG['gbs_under_way'] = '该团报活动正在火热进行中，距离结束时间还有：';
$_LANG['gbs_finished'] = '该团报活动已结束，正在等待处理...';
$_LANG['gbs_succeed'] = '该团报活动已成功结束！';
$_LANG['gbs_fail'] = '该团报活动已结束，没有成功。';
...
$_LANG['gb_notice_login'] = '提示：您需要先注册成为本站会员并且登录后，才能参加课程团购!';
$_LANG['gb_error_goods_lacking'] = '对不起，课程满员，请您修改数量！';
$_LANG['gb_error_status'] = '对不起，该团报活动已经结束或尚未开始，现在不能参加！';
$_LANG['gb_error_login'] = '对不起，您没有登录，不能参加团报，请您先登录！';
$_LANG['group_goods_empty'] = '当前没有团报活动';
...
$_LANG['au_order_placed'] = '您已经预订此课程了，如果您想重新报名，请先取消原来的报名单';
$_LANG['au_no_bid'] = '该拍卖活动没有人出价，不能报名';
$_LANG['au_final_bid_not_you'] = '您不是最高出价者，不能报名';
$_LANG['au_buy_after_login'] = '请您先登录';
$_LANG['au_is_winner'] = '恭喜您，您已经赢得了该课程的报名权。请点击下面的报名按钮。';

/* 批发部分语言项 */
$_LANG['ws_login_please'] = '请您先登录';
$_LANG['ws_return_home'] = '返回首页';
$_LANG['wholesale'] = '团报';
$_LANG['no_wholesale'] = '没有团报课程';
$_LANG['ws_price'] = '团报价';
$_LANG['ws_subtotal'] = '小计';
$_LANG['ws_invalid_goods_number'] = '请输入正确的数量';
$_LANG['ws_attr_not_matching'] = '您选择的课程属性不存在，请参照团报价格单选择';
$_LANG['ws_goods_number_not_enough'] = '您报名的数量没有达到团报的最小数量，请参照团报价格单';
$_LANG['ws_goods_attr_exists'] = '该课程已经在课程书包中，不能再次加入';
$_LANG['ws_remark'] = '请输入您的联系方式、付款方式和配送方式等信息';
$_LANG['ws_order_submitted'] = '您的报名单已提交成功，请记住您的报名单编号: %s。';
...
$_LANG['topic_goods_empty'] = '当前没有专题课程';
...
/* 按钮 */
$_LANG['btn_direct_buy'] = '直接报名';
$_LANG['btn_buy'] = '报名';
$_LANG['btn_collect'] = '收藏';
$_LANG['btn_add_to_cart'] = '加入课程书包';
...
$_LANG['please_select_attr'] = '你加入课程书包的课程有不同子课程可选，你是要否立即跳转到课程详情选择子课程？';

/* 促销信息栏 */
$_LANG['snatch_promotion'] = '[夺宝]';
$_LANG['group_promotion'] = '[团报]';
$_LANG['auction_promotion'] = '[转让]';
...
$_LANG['course_telephone'] = '联系电话';
$_LANG['course_desc'] = '其它';
$_LANG['course_market_price'] = '原    价';
$_LANG['course_discount_price'] = '优惠价';
