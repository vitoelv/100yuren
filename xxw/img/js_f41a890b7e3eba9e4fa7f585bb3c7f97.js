...
;Drupal.locale = { 'pluralFormula': function($n) { return Number(($n!=1)); }, 'strings': { "Unspecified error": "未知错误", "The changes to these blocks will not be saved until the \x3cem\x3eSave blocks\x3c/em\x3e button is clicked.": "对区块的修改只有在点击\x3cem\x3e保存区块\x3c/em\x3e按钮之后才生效。", "Your server has been successfully tested to support this feature.": "您的服务器环境已经通过测试，支持这项功能。", "Your system configuration does not currently support this feature. The \x3ca href=\"http://drupal.org/node/15365\"\x3ehandbook page on Clean URLs\x3c/a\x3e has additional troubleshooting information.": "您的系统当前不支持该功能。 更多详细信息请参阅\x3ca href=\"http://drupal.org/node/15365\"\x3e简洁URLs手册\x3c/a\x3e 。", "Testing clean URLs...": "测试简洁链接。。。", "Go to previous page": "返回上一个页面", "Go to next page": "去下一个页面", "Go to first page": "到第一页", "Go to last page": "到最后一页", "An error occurred. \n@uri\n@text": "出现错误。\n@uri\n@text", "An error occurred. \n@uri\n(no information available).": "出现错误。\n@uri\n（没有可用信息）", "An HTTP error @status occurred. \n@uri": "出现一个HTTP错误 @status\n@uri", "Drag to re-order": "拖放重新排序", "Changes made in this table will not be saved until the form is submitted.": "在此表格中的修改只有在整个表单提交后才会被保存。", "Select all rows in this table": "选择此表中所有的行", "Deselect all rows in this table": "取消选择此表中所有的行", "Split summary at cursor": "在光标处截断摘要", "Join summary": "合并摘要", "An error occurred at @path.": "在 @path 中发生错误。", "jQuery UI Tabs: Mismatching fragment identifier.": "jQuery UI 选项卡: 分段标识不匹配。", "jQuery UI Tabs: Not enough arguments to add tab.": "jQuery UI 选项卡: 添加选项卡的参数不完整。" } };;
/*
...
throw new SyntaxError('JSON.parse');};}})();;// $Id: ddblock.js,v 1.3 2009/02/20 16:09:18 ppblaauw Exp $
